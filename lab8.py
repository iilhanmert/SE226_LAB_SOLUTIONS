...
class Count(ABC):
    def __init__(a_name, address):
        a_name.address = address
...
class ListCount(Count):
    ...
    def calculateFreqs(self, address):
        ...
        for i in range(0, len(my_list)):
            print(f"Frequenct of, {my_list[i]} is : {x.count(my_list[i])}")
...
address1 = "/Users/Mert/Desktop/strange.txt"
